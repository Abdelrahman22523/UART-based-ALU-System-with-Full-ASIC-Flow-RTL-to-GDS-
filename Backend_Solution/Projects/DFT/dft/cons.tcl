...
#set_dont_touch_network "$DFT_CLK_NAME"
...
set scan_in_delay [expr 0.2*$DFT_CLK_PER]
set scan_out_delay [expr 0.2*$DFT_CLK_PER]

#Constrain Scan Input Paths
set_input_delay $scan_in_delay -clock $DFT_CLK_NAME [get_port SI]
set_input_delay $scan_in_delay -clock $DFT_CLK_NAME [get_port SE]
#set_input_delay $scan_in_delay -clock $DFT_CLK_NAME [get_port test_mode]

#Constrain Scan Output Paths
set_output_delay $scan_out_delay -clock $DFT_CLK_NAME [get_port SO]
