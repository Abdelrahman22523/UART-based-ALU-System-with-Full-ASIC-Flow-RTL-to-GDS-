...
# Created by write_sdc on Tue Sep 30 21:11:53 2025
...
create_clock [get_ports scan_clk]  -period 5  -waveform {0 2}
set_input_delay -clock UART_RX_CLK  54.2594  [get_ports UART_RX_IN]
set_input_delay -clock scan_clk  1  [get_ports {SI[2]}]
set_input_delay -clock scan_clk  1  [get_ports {SI[1]}]
set_input_delay -clock scan_clk  1  [get_ports {SI[0]}]
set_input_delay -clock scan_clk  1  [get_ports SE]
set_output_delay -clock UART_TX_CLK  1736.3  [get_ports UART_TX_O]
set_output_delay -clock UART_RX_CLK  54.2594  [get_ports parity_error]
set_output_delay -clock UART_RX_CLK  54.2594  [get_ports framing_error]
set_output_delay -clock scan_clk  1  [get_ports {SO[2]}]
set_output_delay -clock scan_clk  1  [get_ports {SO[1]}]
set_output_delay -clock scan_clk  1  [get_ports {SO[0]}]
